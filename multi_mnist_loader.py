...
class MNIST(data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=True, multi=False):
    ...
    def download(self):
        """Download the MNIST data if it doesn't exist in processed already."""
